      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-4 text-navy-600 dark:text-navy-300 leading-relaxed">
            ...
            <p>
              {t('about.storyP3', 'Today, Petro Bridge Solutions has grown into a premier petroleum logistics coordination company in Tanzania. We serve enterprise clients across multiple industries, coordinate hundreds of millions of liters of fuel annually through a robust network of pre-qualified carriers, and maintain a track record of reliable, on-time deliveries. Our team has expanded with logistics professionals operating from our coordination center in Dar es Salaam.')}
            </p>
            <p>
