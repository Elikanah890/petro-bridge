        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-navy-900 dark:text-white mb-2">{service.title}</h3>
              <p className="text-gold-600 dark:text-gold-500 font-medium text-sm mb-4">{service.subtitle}</p>
              <p className="text-navy-600 dark:text-navy-300 leading-relaxed mb-6 flex-1">{service.description}</p>
