          ...
          {services.map((service, i) => (
            ...
            >
              <div className={i % 2 === 1 ? 'lg:[direction:ltr]' : ''}>
                ...
                <p className="text-gold-600 dark:text-gold-500 font-medium mb-4">{service.subtitle}</p>
                <p className="text-navy-600 dark:text-navy-300 leading-relaxed mb-8">{service.description}</p>
